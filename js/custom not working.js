(function() {
	...
	var isMobile = {
		Android: function() {
			...
			iOS: function() {
			return navigator.userAgent.match(/iPh|iPad|iPod/i);
		},
			Opera: function() {
...
/*8888888888888888888888888888888888*/
    ...
    // Manage the visibility of elements based on the selected filter
    if (data === '*') {
		console.log("Showing all elements except initially hidden");
		// Show all elements but keep initially hidden elements hidden
		$('.single-portfolio').removeAttr('hidden');
		$('.initially-hidden').attr('hidden', true);
	  } else {
		console.log("Showing elements of the selected category and managing initially hidden");
		$('.single-portfolio').attr('hidden', true); // Hide all elements
		$(data).removeAttr('hidden'); // Show elements of the selected category
		// Re-hide initially hidden elements that do not match the selected category
		$('.initially-hidden').each(function() {
		  var element = $(this);
		  var classNames = element.attr('class').split(' ');
		  var matchesCategory = classNames.some(function(className) {
